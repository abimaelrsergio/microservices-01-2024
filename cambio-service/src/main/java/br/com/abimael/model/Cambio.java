...
public class Cambio implements Serializable {
	...
	@Transient
	private BigDecimal convetedValue;
	...
	public Cambio(Long id, String from, String to, BigDecimal conversionFactor, BigDecimal convetedValue,
			String environment) {
		this.id = id;
		this.from = from;
		this.to = to;
	...
	public BigDecimal getConvetedValue() {
		return convetedValue;
	}

	public void setConvetedValue(BigDecimal convetedValue) {
		this.convetedValue = convetedValue;
	}
